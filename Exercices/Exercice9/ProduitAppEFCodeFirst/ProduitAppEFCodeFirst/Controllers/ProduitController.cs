...
using ProduitAppEFCodeFirst.Context;
...
namespace ProduitAppEFCodeFirst.Controllers
{
    public class ProduitController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProduitID,designation,prix,CategorieID")] Produit produit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProduitID,designation,prix,CategorieID")] Produit produit)
        {
            if (ModelState.IsValid)
            {
